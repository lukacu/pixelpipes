 ...
 * 
 */
SharedVariable GaussianBlur(std::vector<SharedVariable> inputs) noexcept(false) {
 ...
 * 
 */
SharedVariable LinearFilter(std::vector<SharedVariable> inputs) noexcept(false) {
