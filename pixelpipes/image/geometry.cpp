 ...
 * 
 */
SharedVariable RemapImage(std::vector<SharedVariable> inputs, ContextHandle context, Interpolation interpolation, BorderStrategy border) {
...
SharedVariable MaskBounds(std::vector<SharedVariable> inputs, ContextHandle context) noexcept(false) {
 ...
 * 
 */
SharedVariable Rotate(std::vector<SharedVariable> inputs, ContextHandle context) noexcept(false) {
 ...
 * 
 */
SharedVariable Flip(std::vector<SharedVariable> inputs, ContextHandle context) noexcept(false) {
 ...
 * 
 */
SharedVariable ImageCrop(std::vector<SharedVariable> inputs, ContextHandle context) {
