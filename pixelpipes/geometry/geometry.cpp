...
SharedVariable BoundingBox(std::vector<SharedVariable> inputs, ContextHandle context) {
 ...
 * 
 */
SharedVariable MakeRectangle(std::vector<SharedVariable> inputs, ContextHandle context) {
